...
class _MechanicDashboardState extends State<MechanicDashboard> with SingleTickerProviderStateMixin {
  int _currentIndex = 0;
...
class DashboardHome extends StatelessWidget {
  ...
  Widget _buildRequestCard(ServiceRequest request) {
    Color priorityColor = request.priority == 'Emergency' ? Colors.red : 
                         request.priority == 'High' ? Colors.orange : Colors.blue;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildMetricItem('Customer Satisfaction', '4.8/5', Icons.sentiment_satisfied),
            ],
          ),
        ],
      ),
...
class _ActiveJobsScreenState extends State<ActiveJobsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDetailedJobCard(ActiveJob job) {
    Color statusColor = job.status == 'In Progress' ? Colors.orange : 
                       job.status == 'En Route' ? Colors.blue : Colors.green;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.directions_car, color: Color(0xFF7E57C2), size: 16),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        job.vehicle,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text(job.issue, style: TextStyle(fontSize: 11, color: Color(0xFF666666))),
                    Spacer(),
                    Icon(Icons.attach_money, size: 12, color: Colors.green),
                    SizedBox(width: 4),
                    Text(job.earnings, style: TextStyle(fontSize: 11, color: Colors.green, fontWeight: FontWeight.w600)),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildScheduledJobsTab() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.calendar_today, size: 64, color: Color(0xFF7E57C2).withOpacity(0.3)),
          SizedBox(height: 16),
          Text(
            'Scheduled Jobs',
            style: TextStyle(
  ...
  Widget _buildMessageBubble(ChatMessage message) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          if (!message.isMe) CircleAvatar(radius: 12, child: Icon(Icons.person, size: 12)),
          ...
          if (message.isMe) SizedBox(width: 8),
          if (message.isMe) CircleAvatar(radius: 12, backgroundColor: Color(0xFF7E57C2), child: Icon(Icons.person, size: 12, color: Colors.white)),
        ],
      ),
    );
  }
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget _buildMenuItems() {
    final menuItems = [
      ...
      _MenuItem(Icons.payment, 'Payment Methods', 'Bank accounts & payment setup'),
      ...
      _MenuItem(Icons.notifications, 'Notifications', 'Configure alert preferences'),
      ...
      _MenuItem(Icons.logout, 'Logout', 'Sign out of your account', isLogout: true),
    ];
