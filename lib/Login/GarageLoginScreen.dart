...
import 'package:smart_roadside/Login/GarageRegister.dart';
import 'package:smart_roadside/garage/garageDashboardd.dart';
...
class _GarageLoginPageState extends State<GarageLoginPage> {
  ...
  void _login() async {
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MechanicDashboard()));
  }
