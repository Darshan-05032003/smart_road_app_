...
import 'package:smart_roadside/views/auth/garage_login_view.dart';
import 'package:smart_roadside/views/auth/insurance_login_view.dart';
import 'package:smart_roadside/views/auth/tow_provider_login_view.dart';
import 'package:smart_roadside/views/auth/vehicle_owner_login_view.dart';
import 'package:smart_roadside/views/auth/admin_login_view.dart';
      ...
      switch (role) {
        ...
        case 'Garage/Mechanic':
          Navigator.push(
            // ignore: use_build_context_synchronously
            context,
            MaterialPageRoute(builder: (context) => GarageLoginPage()),
          );
          break;
        case 'Tow Provider':
          Navigator.push(
