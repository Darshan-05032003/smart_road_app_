...
import 'package:smart_roadside/views/insurance/insurance_dashboard_view.dart';
import 'package:smart_roadside/views/auth/insurance_register_view.dart';
  ...
  void _login() async {
    ...
    FirebaseAuth.instance
        ...
        .then((userCredential) {
          ...
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => InsuranceDashboard()));
        })
        .catchError((error) {
          // Handle login error
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => InsuranceRegistrationPage(),
                            ),
                          );
                        },
                        child: Text(
