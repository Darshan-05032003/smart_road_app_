...
class _InsuranceDashboardState extends State<InsuranceDashboard>
  ...
  void _loadSampleData() {
    ...
    _activities.addAll([
      Activity(
        'Claim Approved',
        'CL-2024-0009 approved by Sarah Chen',
        '2 hours ago',
        Icons.check_circle,
        Colors.green,
      ),
      Activity(
        'Document Uploaded',
        'James Wilson uploaded repair invoice',
        '4 hours ago',
        Icons.upload,
        Colors.blue,
      ),
      Activity(
        'New Claim Filed',
        'Emma Rodriguez filed theft claim',
        '6 hours ago',
        Icons.add_circle,
        Colors.orange,
      ),
      ...
      Activity(
        'Fraud Flagged',
        'AI detected suspicious pattern in CL-2024-0011',
        '1 day ago',
        Icons.warning,
        Colors.red,
      ),
      Activity(
        'Policy Renewed',
        'POL-2024-0456 renewed for Michael Chen',
        '2 days ago',
        Icons.autorenew,
        Colors.purple,
      ),
    ...
    _quickActions.addAll([
      {
        ...
        'action': _createNewClaim,
      },
      {
        'title': 'Quick Approve',
        'icon': Icons.bolt,
        'color': Color.fromRGBO(76, 175, 80, 1),
        'action': _quickApprove,
      },
      {
        'title': 'Fraud Scan',
        'icon': Icons.security,
        'color': Color.fromRGBO(255, 160, 0, 1),
        'action': _runFraudScan,
      },
      {
        'title': 'Export Report',
        'icon': Icons.download,
      ...
      },
      {
        ...
        'action': _openCustomerChat,
      },
      {
        'title': 'Policy Review',
        'icon': Icons.policy,
        'color': Color.fromRGBO(244, 67, 54, 1),
        'action': _reviewPolicies,
      },
    ]);
  }
      ...
      filtered = filtered
          .where(
            (claim) =>
                ...
                claim.priority == _selectedFilter,
          )
          .toList();
    }
      ...
      filtered = filtered
          .where(
            (claim) =>
                ...
                claim.customerName.toLowerCase().contains(
                  _searchQuery.toLowerCase(),
                ) ||
                claim.vehicle.toLowerCase().contains(
                  _searchQuery.toLowerCase(),
                ) ||
                claim.policyNo.toLowerCase().contains(
                  _searchQuery.toLowerCase(),
                ),
          )
          .toList();
  ...
  Widget _buildAIStatusButton() {
    return IconButton(
      icon: Icon(
        _isAIEnabled ? Icons.auto_awesome : Icons.block,
  ...
  Widget _buildCurrentScreen(bool isLargeScreen) {
    switch (_currentIndex) {
      case 0:
        return _buildDashboard(isLargeScreen);
      case 1:
        return _buildClaimsManagement(isLargeScreen);
      case 2:
        return _buildAnalytics(isLargeScreen);
      case 3:
        return _buildPolicies(isLargeScreen);
      case 4:
        return _buildSettings(isLargeScreen);
      default:
        return _buildDashboard(isLargeScreen);
    }
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'You have ${_analyticsData['pendingClaims']} pending claims that need your attention today.',
  ...
  Widget _buildQuickStats(bool isLargeScreen) {
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard(
          'Revenue',
          '\$${(_analyticsData['revenue'] / 1000).toStringAsFixed(0)}K',
          Icons.attach_money,
          Color(0xFF9C27B0),
          '+15%',
        ...
        if (isLargeScreen)
          _buildStatCard(
            'Payouts',
            '\$${(_analyticsData['totalPayouts'] / 1000).toStringAsFixed(1)}K',
            Icons.payment,
            Color(0xFF2196F3),
            '-3%',
            _showPayouts,
        ...
        if (isLargeScreen)
          _buildStatCard(
            'Satisfaction',
            '${_analyticsData['customerSatisfaction']}/5',
            Icons.star,
            Color(0xFFFFC107),
            '+2%',
            _showSatisfaction,
        ...
        if (isLargeScreen)
          _buildStatCard(
            'Processing Time',
            '${_analyticsData['avgProcessingTime']} days',
            Icons.timer,
            Color(0xFF00BCD4),
            '-12%',
            _showProcessingTime,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildAIPredictionItem(
            'Fraud Risk Alert',
            '3 claims flagged for manual review',
            Icons.warning,
            Colors.orange,
            _reviewFraudCases,
          ),
          _buildAIPredictionItem(
            'High Payout Prediction',
            '2 claims exceeding \$5,000 estimated',
            Icons.trending_up,
            Colors.red,
            _reviewHighPayouts,
          ),
          _buildAIPredictionItem(
            'Quick Approvals',
            '8 claims ready for instant approval',
            Icons.bolt,
            Colors.green,
            _quickApproveAll,
          ),
          ...
          Expanded(
            child: TextField(
              decoration: InputDecoration(
                hintText:
                    'Search claims by ID, customer, vehicle, or policy...',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${policy.customerName} • ${policy.vehicle}',
        ...
        children: [
          ...
          _buildSettingsSection('Preferences', [
            ...
            _buildSettingsItem(
              'Auto-Approval Rules',
              Icons.auto_awesome,
              'Set up automatic claim approval',
            ),
            _buildSettingsItem(
              'Reporting Preferences',
              Icons.analytics,
              'Configure report formats and schedules',
            ),
          ]),
        ],
      ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('New claim created successfully'),
                                backgroundColor: Colors.green,
                              ),
                            );
                          },
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Photos, police reports, repair estimates, etc.',
            style: TextStyle(color: Color(0xFF666666), fontSize: 12),
          ),
          SizedBox(height: 12),
          OutlinedButton.icon(
  ...
  void _quickApproveAll() =>
      _showMessage('Quick Approving All Eligible Claims');
  ...
  void _showProcessingTime() =>
      _showMessage('Showing processing time analytics');
