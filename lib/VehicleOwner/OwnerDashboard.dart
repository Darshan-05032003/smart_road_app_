...
class _VehicleDashboardScreenState extends State<VehicleDashboardScreen> 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _currentIndex == 0 ? _buildEnhancedFloatingActions() : null,
          ...
          items: [
            BottomNavigationBarItem(
              ...
              activeIcon: Container(
                ...
                child: Icon(Icons.home_rounded, color: Color.fromRGBO(109, 40, 217, 1)),
              ),
              label: 'Home',
            ),
            BottomNavigationBarItem(
              ...
              activeIcon: Container(
                ...
                child: Icon(Icons.handyman_rounded, color: Color.fromRGBO(109, 40, 217, 1)),
              ),
              label: 'Services',
            ),
            BottomNavigationBarItem(
              ...
              activeIcon: Container(
                ...
                child: Icon(Icons.history_rounded, color: Color.fromRGBO(109, 40, 217, 1)),
              ),
              label: 'History',
            ),
            BottomNavigationBarItem(
              ...
              activeIcon: Container(
                ...
                child: Icon(Icons.person_rounded, color: Color.fromRGBO(109, 40, 217, 1)),
              ),
              label: 'Profile',
            ),
          ],
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                'View All',
                style: TextStyle(
                  color: Color.from(alpha: 1, red: 0.427, green: 0.157, blue: 0.851),
                  fontWeight: FontWeight.w600,
                ),
              ),
            ],
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color.fromRGBO(109, 40, 217, 1), Color.fromRGBO(139, 92, 246, 1)],
            ),
            borderRadius: BorderRadius.circular(10),
          ),
...
class _RequestScreenState extends State<RequestScreen> {
  ...
  final List<String> _vehicleTypes = ['Car', 'Motorcycle', 'SUV', 'Truck', 'Van'];
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage('https://via.placeholder.com/400x200?text=Map+View'),
                fit: BoxFit.cover,
              ),
            ),
          ),
            ...
            children: _issueTypes.map((issue) {
              ...
              return ListTile(
                leading: Container(
                  ...
                  height: 32,
                  decoration: BoxDecoration(
                    color: isSelected ? Color(0xFF7E57C2).withOpacity(0.1) : Color(0xFFF5F5F7),
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
                    _getIssueIcon(issue),
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 4,
              children: (garage['services'] as List<String>).take(3).map((service) {
                return Chip(
                  label: Text(service),
        ...
        trailing: Column(
          ...
          children: [
            Text(
              garage['eta'],
              style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromRGBO(109, 40, 217, 1)),
            ),
            ElevatedButton(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Color.fromRGBO(109, 40, 217, 1)),
            child: Text('Confirm'),
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow('Date & Time', '${service['date']} at ${service['time']}'),
...
class _EnhancedProfileScreenState extends State<EnhancedProfileScreen> {
  ...
  void initState() {
    ...
    _vehicleController = TextEditingController(text: widget.userData['vehicle']);
  }
          ...
          Stack(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.camera_alt_rounded, size: 16, color: Color.fromRGBO(109, 40, 217, 1)),
              ),
            ],
          ),
          SizedBox(height: 16),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildProfileField('Full Name', _nameController, Icons.person_rounded),
            SizedBox(height: 12),
            _buildProfileField('Email', _emailController, Icons.email_rounded),
            SizedBox(height: 12),
            _buildProfileField('Vehicle Info', _vehicleController, Icons.directions_car_rounded),
            SizedBox(height: 20),
          ElevatedButton(
    onPressed: (){_saveProfile();}, // ✅ Correct place for callback
  style: ElevatedButton.styleFrom(
